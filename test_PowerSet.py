...
class MyTestCase(unittest.TestCase):
    ...
    def test_issubset(self):
        ...
        arr.put('4')
        arr.put('5')
        self.assertEqual(arr.issubset({'1', '3', '2', }), True)

    def test_issubset_no_enter(self):
        arr = PowerSet_without_hush.PowerSet()
        arr.put('1')
        arr.put('2')
        arr.put('3')
        arr.put('4')
        arr.put('5')
        self.assertEqual(arr.issubset({'12', '34', '56'}), False)

    def test_issubset_part_enter(self):
        arr = PowerSet_without_hush.PowerSet()
        arr.put('1')
        arr.put('2')
        arr.put('3')
        self.assertEqual(arr.issubset({'1', '2', '3', '12', '34', '56'}), False)
